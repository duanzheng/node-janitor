...
import { ClearOutlined, DeleteOutlined, InfoCircleOutlined } from '@ant-design/icons';
      ...
      <Layout>
        ...
        >
          ...
          >
            ...
            <span>
              Space Saved:{' '}
              {totalSaved > 0 ? `${(totalSaved / 1024 / 1024 / 1024).toFixed(2)} GB` : '0 GB'}
            </span>
          </div>
        </Footer>
      </Layout>
